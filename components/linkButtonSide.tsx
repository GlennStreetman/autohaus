...
const textRegular =
    ...
    text-base text-black hover:text-primary font-heading  subpixel-antialiased tracking-wider
    relative
    inline-block
    transition-all
    duration-500
...
const textAtLocation =
    `flex flex-row shrink p-2 bg-transparent gap-1  
    text-base text-black  font-heading  subpixel-antialiased tracking-wider
    relative
    inline-block
    shrink m-auto
    underline
...
export function NextLinkButtonSide(p: props) {
...
function LinkButtonSide(p: props) {
    return (
