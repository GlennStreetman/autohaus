...
function Topper() {
    ...
    return (
        <div className="z-10 flex w-screen right-0 fixed flex justify-end p-2 gap-2 ">
            <IconButton text="Open: Mon-Fri 8am-5pm" callback={() => {}} icon={calendar} />
            <a href="https://goo.gl/maps/J17sGmyvTLv2JDWQ8">
                <IconButton text="2621 Pico Blvd" callback={() => {}} icon={location} />
            </a>
            <a href="tel:555-555-5555">
                <IconButton text="555-555-5555" callback={() => {}} icon={telephone} />
            </a>
            <HighlightButton text="Request Quote" callback={() => {}} icon={repair} />
            {/* </div> */}
